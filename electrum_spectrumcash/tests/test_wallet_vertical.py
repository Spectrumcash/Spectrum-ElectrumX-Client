...
from electrum_spectrumcash import storage, bitcoin, keystore, bip32
from electrum_spectrumcash import Transaction
from electrum_spectrumcash import SimpleConfig
from electrum_spectrumcash.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_spectrumcash.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet
from electrum_spectrumcash.util import bfh, bh2u
from electrum_spectrumcash.transaction import TxOutput
from electrum_spectrumcash.mnemonic import seed_type

from electrum_spectrumcash.plugins.trustedcoin import trustedcoin
...
class TestWalletKeystoreAddressIntegrityForMainnet(SequentialTestCase):
    ...
    def test_electrum_multisig_seed_standard(self, mock_write):
        ...
        # electrum_spectrumcash seed: ghost into match ivory badge robot record tackle radar elbow traffic loud
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        # electrum_spectrumcash seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
