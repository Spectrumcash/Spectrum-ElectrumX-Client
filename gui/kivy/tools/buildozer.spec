...
title = Electrum-CHAINCOIN

# (str) Package name
package.name = Electrum_CHAINCOIN

# (str) Package domain (needed for android/ios packaging)
package.domain = org.chaincoin.electrum
...
requirements = python3crystax==3.6, android, openssl, plyer, kivy==master, libsecp256k1, x11_hash
...
icon.filename = %(source.dir)s/icons/electrum-chaincoin.png
...
android.add_activities = org.chaincoin.electrum.qr.SimpleScannerActivity
