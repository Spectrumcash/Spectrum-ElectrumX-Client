...
from electrum_spectrumcash.bip32 import BIP32Node, InvalidMasterKeyVersionBytes
from electrum_spectrumcash.i18n import _
from electrum_spectrumcash.plugin import Device
from electrum_spectrumcash.keystore import Hardware_KeyStore, xpubkey_to_pubkey, Xpub
from electrum_spectrumcash.transaction import Transaction
from electrum_spectrumcash.wallet import Standard_Wallet
from electrum_spectrumcash.crypto import hash_160
from electrum_spectrumcash.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_spectrumcash.base_wizard import ScriptTypeNotSupported
...
try:
    ...
    class ElectrumColdcardDevice(ColdcardDevice):
        ...
        def mitm_verify(self, sig, expect_xpub):
            ...
            # - customized to use specific EC library of SpectrumCash-Electrum.
...
class Coldcard_KeyStore(Hardware_KeyStore):
    ...
    def _encode_txin_type(txin_type):
        # Map from electrum_spectrumcash code names to our code numbers.
