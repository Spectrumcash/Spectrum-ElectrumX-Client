...
from electrum_spectrumcash.paymentrequest import InvoiceStore
from electrum_spectrumcash.util import profiler, InvalidPassword, send_exception_to_crash_reporter
from electrum_spectrumcash.plugin import run_hook
from electrum_spectrumcash.util import format_satoshis, format_satoshis_plain
from electrum_spectrumcash.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrum_spectrumcash import blockchain
...
#Factory.register('InstallWizard', module='electrum_spectrumcash.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_spectrumcash.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_spectrumcash.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_spectrumcash.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_spectrumcash_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_spectrumcash.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Montserrat',
               'electrum_spectrumcash/gui/kivy/data/fonts/Montserrat-Regular.otf',
               'electrum_spectrumcash/gui/kivy/data/fonts/Montserrat-Regular.otf',
               'electrum_spectrumcash/gui/kivy/data/fonts/Montserrat-Bold.otf',
               'electrum_spectrumcash/gui/kivy/data/fonts/Montserrat-Bold.otf')


from electrum_spectrumcash.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_new_intent(self, intent):
        if intent.getScheme() != 'spectrumcash':
            return
    ...
    def __init__(self, **kwargs):
        ...
        title = _('SpectrumCash Electrum App')
    ...
    def on_qr(self, data):
        from electrum_spectrumcash.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        if data.startswith('spectrumcash:'):
            self.set_URI(data)
            return
        # try to decode transaction
        from electrum_spectrumcash.transaction import Transaction
        from electrum_spectrumcash.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_spectrumcash.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('electrum_spectrumcash/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def scan_qr(self, on_complete):
        ...
        SimpleScannerActivity = autoclass("org.spectrumcash.electrum.qr.SimpleScannerActivity")
    ...
    def build(self):
        return Builder.load_file('electrum_spectrumcash/gui/kivy/main.kv')
    ...
    def on_start(self):
        ...
        # bind intent for spectrumcash: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def show_tor_warning(self):
        ...
        img_error = 'atlas://electrum_spectrumcash/gui/kivy/theming/light/error'
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_spectrumcash/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_spectrumcash.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_spectrumcash.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_spectrumcash_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_spectrumcash_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "electrum_spectrumcash/gui/icons/electrum-spectrumcash.png"
    ...
    def get_max_amount(self):
        from electrum_spectrumcash.transaction import TxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('SpectrumCash Electrum', message,
                            app_icon=icon, app_name='SpectrumCash Electrum')
        except ImportError:
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_spectrumcash/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_spectrumcash/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_spectrumcash/gui/kivy/theming/light/card'
        else:
