...
try:
    imp.load_module('electrum_spectrumcash', *imp.find_module('../electrum_spectrumcash'))
    from electrum_spectrumcash import constants, keystore, storage, SimpleConfig
    from electrum_spectrumcash.version import ELECTRUM_VERSION
    from electrum_spectrumcash.gui.qt import update_checker
    from electrum_spectrumcash.plugin import Plugins
    from electrum_spectrumcash.storage import WalletStorage
    from electrum_spectrumcash.util import InvalidPassword
...
CONFIG_NAME = '.update-last-version-spectrumcash-electrum'
