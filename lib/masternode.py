...
class MasternodeAnnounce(object):
    ...
    Attributes:
        ...
        - vin: 1K Chaincoin input (outpoint: 1K Chaincoin input for proto > 70208).
        - addr: Address that the masternode can be reached at.
        - collateral_key: Key that can spend the 1K Chaincoin input.
