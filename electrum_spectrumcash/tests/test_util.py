...
from electrum_spectrumcash.util import (format_satoshis, format_fee_satoshis, parse_URI,
...
class TestUtil(SequentialTestCase):
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?label=electrum_spectrumcash%20test',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'label': 'electrum_spectrumcash test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?message=electrum_spectrumcash%20test',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'message': 'electrum_spectrumcash test', 'memo': 'electrum_spectrumcash test'})
    ...
    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?amount=0.00004&label=electrum_spectrumcash-test&message=electrum_spectrumcash%20test&test=none&r=http://domain.tld/page',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'amount': 4000, 'label': 'electrum_spectrumcash-test', 'message': u'electrum_spectrumcash test', 'memo': u'electrum_spectrumcash test', 'r': 'http://domain.tld/page', 'test': 'none'})
