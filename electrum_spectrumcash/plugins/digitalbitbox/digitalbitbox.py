...
from electrum_spectrumcash.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_spectrumcash.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                              is_address)
from electrum_spectrumcash.bip32 import BIP32Node
from electrum_spectrumcash import ecc
from electrum_spectrumcash.ecc import msg_magic
from electrum_spectrumcash.wallet import Standard_Wallet
...
from electrum_spectrumcash.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from electrum_spectrumcash.util import to_string, UserCancelled, UserFacingException
from electrum_spectrumcash.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_spectrumcash.network import Network
from electrum_spectrumcash.logging import get_logger
...
class DigitalBitbox_Client():
    ...
    def check_device_dialog(self):
        ...
        if not self.setupRunning:
            self.isInitialized = True # Wallet exists. SpectrumCash-Electrum code later checks if the device matches the wallet
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("SpectrumCash-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
