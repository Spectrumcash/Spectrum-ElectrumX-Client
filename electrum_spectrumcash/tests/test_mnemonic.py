...
from electrum_spectrumcash import keystore
from electrum_spectrumcash import mnemonic
from electrum_spectrumcash import old_mnemonic
from electrum_spectrumcash.util import bh2u, bfh
from electrum_spectrumcash.mnemonic import is_new_seed, is_old_seed, seed_type
from electrum_spectrumcash.version import SEED_PREFIX_SW, SEED_PREFIX
...
class Test_NewMnemonic(SequentialTestCase):
    ...
    def test_mnemonic_to_seed_basic(self):
        # note: not a valid electrum_spectrumcash seed
