...
from electrum_spectrumcash.util import format_satoshis
from electrum_spectrumcash.bitcoin import is_address, COIN, TYPE_ADDRESS
from electrum_spectrumcash.transaction import TxOutput
from electrum_spectrumcash.wallet import Wallet
from electrum_spectrumcash.storage import WalletStorage
from electrum_spectrumcash.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_spectrumcash.interface import deserialize_server
from electrum_spectrumcash.logging import console_stderr_handler
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrum_spectrumcash.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config
