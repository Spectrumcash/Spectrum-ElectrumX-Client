...
from electrum_spectrumcash.util import base_units_list
...
from electrum_spectrumcash import coinchooser
...
<SettingsDialog@Popup>
    id: settings
    title: _('SpectrumCash Electrum Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for SpectrumCash amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_spectrumcash/gui/kivy/uix/ui_screens/proxy.kv')
