...
from electrum_spectrumcash.commands import Commands, eval_bool
from electrum_spectrumcash import storage
from electrum_spectrumcash.wallet import restore_wallet_from_text
...
class TestCommands(unittest.TestCase):
    ...
    def test_setconfig_non_auth_list(self):
        self.assertEqual(['file:///var/www/', 'https://electrum_spectrumcash.org'],
            Commands._setconfig_normalize_value('url_rewrite', "['file:///var/www/','https://electrum_spectrumcash.org']"))
        self.assertEqual(['file:///var/www/', 'https://electrum_spectrumcash.org'],
            Commands._setconfig_normalize_value('url_rewrite', '["file:///var/www/","https://electrum_spectrumcash.org"]'))
    ...
    def test_setconfig_auth(self):
        ...
        self.assertEqual("['file:///var/www/','https://electrum_spectrumcash.org']",
            Commands._setconfig_normalize_value('rpcpassword', "['file:///var/www/','https://electrum_spectrumcash.org']"))
