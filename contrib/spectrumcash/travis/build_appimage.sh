...
APPDIR="$BUILDDIR/electrum-spectrumcash.AppDir"
...
APPIMAGE="$DISTDIR/SpectrumCash-Electrum-$VERSION-x86_64.AppImage"
...
info "installing electrum-spectrumcash and its dependencies."
...
cp "$PROJECT_ROOT/electrum-spectrumcash.desktop" "$APPDIR/electrum-spectrumcash.desktop"
cp "$PROJECT_ROOT/electrum_spectrumcash/gui/icons/electrum-spectrumcash.png" "$APPDIR/electrum-spectrumcash.png"


# add launcher
cp "$CONTRIB/spectrumcash/travis/apprun.sh" "$APPDIR/AppRun"
