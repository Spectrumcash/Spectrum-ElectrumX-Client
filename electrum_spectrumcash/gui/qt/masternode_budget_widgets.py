...
from electrum_spectrumcash.masternode_budget import BudgetProposal, BudgetVote
from electrum_spectrumcash.masternode_manager import BUDGET_FEE_CONFIRMATIONS
from electrum_spectrumcash.util import block_explorer_URL, format_satoshis_plain
...
def budget_explorer_url(item_type, identifier):
    ...
    if item_type == 'proposal':
        return 'https://spectrumcashwhale.org/p/%s' % identifier
...
class ProposalsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        description = ''.join(['You can create a budget proposal below. ',
                'Proposals require 5 SPECTRUMCASH to create. ',
        ...
        form.addRow(_('Payment Address:'), self.address_edit)
        form.addRow(_('Monthly SPECTRUMCASH Payment:'), self.amount_edit)
    ...
    def update_unsubmitted_proposals(self):
        ...
        self.ready_proposals.setText(str(num) + _(' {} {} ready to be submitted.'.format(noun, article)))
