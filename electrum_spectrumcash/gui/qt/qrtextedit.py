...
class ScanQRTextEdit(ButtonsTextEdit, MessageBoxMixin):
    ...
    def __init__(self, text="", allow_multi=False):
        ...
        if ColorScheme.dark_scheme:
            self.addButton("file_dark.png", self.file_input, _("Read file"))
        else:
            self.addButton("file_light.png", self.file_input, _("Read file"))

        icon = "camera_dark.png" if ColorScheme.dark_scheme else "camera_light.png"
    ...
    def qr_input(self):
        from electrum_spectrumcash import qrscanner, get_config
        try:
